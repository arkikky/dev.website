    ...
    <>
      <div className="flex w-full flex-row space-x-3">
        ...
        <div className="mb-1 flex flex-col">
          <h3 className="mb-3.5 text-base font-medium text-black-900">
            {products.name}
          </h3>
          <div className="flex flex-row items-center">
            ...
            <div
              className={`hsCA25_UpdatedQtyCart hs-dropdown-menu mt-0 ${products.documentId === 'sn4ujm0d1ebbc8lme1ihzsa9' ? 'ml-1' : 'ml-0'} flex w-max rounded-[10px] border border-gray-200 bg-gray-50 px-1 py-1`}
              role="menu"
      ...
      <div className="flex flex-col items-end justify-between">
        <span className="text-base font-medium text-black-900">
