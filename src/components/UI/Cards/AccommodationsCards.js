        ...
        <>
          ...
          >
            ...
            <div className="absolute inset-x-0 inset-y-0 z-[2]">
              ...
              <div className="flex-items absolute inset-x-0 bottom-0 top-auto flex items-center justify-center bg-black-900/[0.58] px-2 py-2 text-center font-bevietnamPro text-xs font-normal capitalize text-white sm:text-base">
                {diskon}
              </div>
            </div>
          </Link>
