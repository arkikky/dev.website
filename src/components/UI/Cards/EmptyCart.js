...
const EmptyCart = ({}) => {
  return (
    <>
      <div className="flex w-full flex-col items-center justify-center rounded-2xl bg-blue-50 px-6 py-6 text-center text-primary">
        ...
        <Link
          href="/"
          className="mt-5 flex flex-row items-center justify-center gap-x-2 rounded-md text-sm leading-initial text-primary underline"
        >
          Buy Tickets
          <svg
