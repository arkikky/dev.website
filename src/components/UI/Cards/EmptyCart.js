...
const EmptyCart = ({}) => {
  return (
    <>
      <div className="flex w-full flex-col items-center justify-center rounded-xl bg-blue-50 px-6 py-6 text-center text-primary">
        <div className="mb-3 flex h-11 w-11 flex-col items-center justify-center overflow-hidden rounded-full bg-blue-400/20">
          <svg
            className="h-7 w-7 shrink-0 stroke-primary"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <Link
          href="/"
          className="mt-7 flex flex-row items-center justify-center gap-x-2 rounded-md text-sm font-medium leading-initial text-primary underline"
        >
          Buy Tickets
          <svg
