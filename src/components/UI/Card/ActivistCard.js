  ...
  const isActivistCard = () => {
    return (
      ...
      >
        {/* @btn */}
        {url !== "" && (
          <div className="absolute bottom-auto left-auto right-3 top-3 z-10 flex h-10 w-10 flex-col items-center justify-center rounded-xl bg-white sm:right-4 sm:top-4">
            <svg
