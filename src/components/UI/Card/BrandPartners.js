...
const BrandSponsor = ({ attributes }) => {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center border border-solid border-[#E6E6E6] hocus:border-secondary rounded-[5px] sm:rounded-[10px] grayscale hocus:grayscale-0 overflow-hidden transition duration-300 ease-in-out px-0 h-[118px] sm:h-[155px] xl:h-[184px]">
        <Image
