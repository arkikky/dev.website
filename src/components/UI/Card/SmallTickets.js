      ...
      <div
        className={`"flex flex-col rounded-xl ${
          type === "VIP"
            ...
            : type === "GROUP"
              ? "ca2024BgSmallGroupPackageTicket bg-[#00ACC7]"
              : "ca2024BgSmallTicket bg-secondary"
        } felx-col relative flex h-[158px] justify-between overflow-hidden px-4.5 py-4 sm:h-full`}
      >
        <div className="relative z-[5] flex flex-row items-center justify-between">
          <span className="w-full max-w-[142px] font-staraBold text-[28px] uppercase leading-[28px] text-white sm:text-[24px] sm:leading-[24px]">
            {title}
          </span>
        ...
        <Link
          ...
          href={url}
          title={`Coinfest Asia 2024 (${title} - Small Tickets)`}
        >
          Secure your spots
          <svg
