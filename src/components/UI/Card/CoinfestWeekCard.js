  ...
  return (
    <>
      <div
        ...
        className={`ca2024SideEventsCards ${featured === true && "active"} col-span-1 flex h-full flex-col overflow-hidden`}
      >
        <div className="relative z-[2] mx-0.5 my-0.5 flex h-full flex-col overflow-hidden rounded-lg bg-white">
