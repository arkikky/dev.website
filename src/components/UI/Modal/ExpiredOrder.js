    ...
    <>
      ...
      >
        <div className="!pointer-events-none flex w-full max-w-[433px] !select-none flex-col items-center justify-center rounded-lg bg-white px-8 pb-8 pt-10 sm:rounded-2xl">
          <div className="flex h-24 w-24 flex-col items-center justify-center rounded-full bg-red-100/20">
            <svg
              className="h-16 w-16 fill-red-500"
          ...
          <div className="mt-8 text-center">
            ...
            <p className="text-balance text-sm font-light text-gray-500">
              {`Your order couldn't be processed. Please check your payment method
