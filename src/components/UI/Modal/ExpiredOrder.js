  ...
  return (
    <>
      <div
        ...
        className={`ca25PaymentProcess_Modals !pointer-events-none fixed inset-x-0 inset-y-0 z-primary flex cursor-default !select-none flex-col items-center justify-center bg-black-900/60 px-2.5 sm:px-0`}
      >
        <div className="!pointer-events-none flex w-full max-w-[433px] !select-none flex-col items-center justify-center rounded-lg bg-white px-8 pb-8 pt-10 sm:rounded-2xl">
          <div className="flex h-24 w-24 flex-col items-center justify-center rounded-full bg-primary/20">
            <svg
              className="h-16 w-16 fill-[#2458F1]"
          ...
          <div className="mt-8 text-center">
            <h2 className="mb-2 text-xl font-semibold">Order Failed</h2>
            <p className="text-sm font-light text-gray-500">
              Unfortunately, your order could not be processed. Please check
              your payment method or try again. For further assistance, contact{' '}
              <Link
