...
const SuccessModal2025 = () => {
  return (
    <>
      {/* @Modal (Success Newsletter) */}
      <button
        id={`btnSuccessNewsletterMdl2025`}
        className={`btnSuccessNewsletterMdl2025 toolsApp invisible absolute bottom-0 left-auto right-0 top-full z-10 hidden h-8 w-8 cursor-pointer flex-col items-center justify-center rounded-[10px] bg-transparent opacity-0 outline-none`}
        ...
        aria-labelledby={`Success Newsletter Modal 2025`}
        data-hs-overlay={`#successNewsletterModal2025`}
      ></button>

      <div
        id={`successNewsletterModal2025`}
        ...
        <div className="absolute inset-x-0 bottom-0 top-0 mx-auto mt-8 flex w-full items-center justify-center px-4 opacity-0 transition-all duration-300 ease-out hs-overlay-open:mt-0 hs-overlay-open:opacity-100 sm:inset-y-0 sm:max-w-[547px] sm:px-0">
          <div className="relative flex flex-col rounded-xl bg-white px-7 py-8 text-center sm:rounded-[18px] sm:px-12 sm:py-14">
            <button
              ...
              aria-labelledby={`successNewsletterModal2025`}
              data-hs-overlay={`#successNewsletterModal2025`}
            >
              <svg
                className="h-4 w-4"
