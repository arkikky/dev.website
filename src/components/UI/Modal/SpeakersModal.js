    ...
    <>
      ...
      >
        <div className="fixed inset-x-0 bottom-0 top-0 mx-auto flex w-full max-w-full translate-y-8 transform items-center justify-center px-4 opacity-0 transition-all duration-300 ease-out hs-overlay-open:translate-y-0 hs-overlay-open:opacity-100 sm:inset-y-0 sm:max-w-[720px] sm:px-0 lg:max-w-[825px]">
          <div className="relative flex w-full flex-col flex-wrap overflow-hidden rounded-[16px] bg-white py-0 sm:flex-row sm:rounded-[18px]">
            <div className="relative w-full min-w-full max-w-full flex-1 bg-gray-500 sm:min-w-[309px] lg:max-w-[309px]">
              <button
                className="hs-dropdown-toggle absolute bottom-auto left-4 right-auto top-4 z-[12] flex h-10 w-10 flex-col items-center justify-center rounded-xl bg-white outline-none sm:left-6 sm:top-6"
                aria-labelledby={`mdlSpeakers`}
            ...
            <div className="flex h-full max-h-[211px] w-full flex-1 flex-col overflow-y-auto bg-white px-4 py-6 sm:max-h-max sm:overflow-hidden sm:px-8 sm:py-10">
              <div className="flex flex-col text-start">
                <div className="flex flex-col">
                  ...
                  {isPosition && (
                    <span className="mt-1 font-bevietnamPro text-base font-light text-[#9C9C9C] sm:text-lg">
                      {isPosition}
                    </span>
                  )}
                </div>
