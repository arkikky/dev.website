...
const Store = ({
  ...
  const stylesCard = {
    general: 'rounded-2xl px-3 pb-3 pt-3 mt-2 sm:py-3',
      ...
      >
        ...
        >
          <div className="flex w-full flex-row items-start justify-between">
            <h2 className="text-white">{`Cart (${store?.length} items)`}</h2>
            <button
          ...
          <div className="my-3 block w-full border-t border-dashed border-gray-400/40"></div>
          ...
          {type === 'mobile' && (
            <>
              <div className="relative flex w-full flex-row items-end justify-between">
                <span className="flex flex-row items-center gap-x-1.5 text-base font-light text-white">
                  {`Subtotal`}{' '}
                  <svg
          ...
          {type === 'general' && (
            <div className="relative mt-1 flex w-full flex-row items-end justify-between">
              ...
              <div className="flex w-max flex-row items-center space-x-2">
                <button
                  className={`h-[52px] w-[126px] cursor-pointer rounded-lg bg-primary px-5 py-3.5 text-center text-sm leading-initial text-white disabled:cursor-not-allowed disabled:bg-primary/70 disabled:text-white/40 sm:rounded-[10px] sm:px-6 sm:py-4 sm:text-base sm:leading-initial`}
                  type="button"
                  tabIndex={-1}
