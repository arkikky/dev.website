    ...
    <>
      ...
      <main className="relative flex flex-col pt-[149px] xl:pt-[159px]">
        ...
        >
          ...
          <div
            className={`duration--[0.5s] absolute bottom-auto left-auto right-[67.5%] top-[16.5%] ${isLoading ? "z-[11] scale-100 opacity-100" : "z-px scale-75 opacity-0"} transform transition delay-[0.5s] ease-in-out xs:right-[61.5%] sm:left-[29.5%] sm:right-auto sm:top-[15.5%] lg:left-[37.5%] lg:top-[17.5%] xl:left-[39.5%] xl:top-[19.5%]`}
          >
            <span className="ca2024LabelNoVenue ca2024LabelPinVenue relative">
              4
            </span>
          ...
          <div
            className={`absolute bottom-[39.5%] left-auto right-[30.5%] top-auto ${isLoading ? "z-[11] scale-100 opacity-100" : "z-px scale-75 opacity-0"} transform transition delay-[0.5s] sm:bottom-[40.5%]  sm:right-[32.5%] lg:bottom-[43.5%] lg:right-[29.5%] xl:bottom-[42.5%] xl:right-[30.5%]`}
          >
            <span className="ca2024LabelNoVenue ca2024LabelPinVenue relative">
              8
            </span>
