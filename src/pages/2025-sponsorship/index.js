        ...
        >
                      ...
                      <div className="space-y-2" key={i}>
                        ...
                        >
                          <input
                            ...
                            type="radio"
                            className="boxShadow-none form-radio pointer-events-none mt-[3px] h-5 w-5 shrink-0 rounded-full  border border-solid border-gray-500/20 bg-transparent text-primary outline-none ring-0 focus:outline-none focus-visible:outline-none sm:mt-[3px]"
          ...
          <div className="flex flex-col">
            ...
            <div className="mb-6 flex flex-col last:mb-0">
              ...
              >
                In Coinfest Asia 2025, we are interested in?{" "}
                <span className="text-red-500">*</span>
              </label>
                  ...
                  (gRslt, i) => (
                    ...
                    >
                      <input
                        ...
                        className="boxShadow-none form-checkbox pointer-events-none mt-[3px] h-5 w-5 shrink-0 rounded border border-solid border-gray-500/20 bg-transparent text-primary outline-none ring-0 focus:outline-none focus-visible:outline-none sm:mt-[3px]"
            ...
            <div className="mb-6 flex flex-col last:mb-0">
              ...
              >
                Your range of budget to sponsor Coinfest Asia 2025?{" "}
                <span className="text-red-500">*</span>
              </label>
          ...
          <div className="flex flex-col">
            <button
              type="submit"
              className={`mt-6 flex w-full flex-col items-center justify-center rounded-[14px] !bg-primary py-4 font-bevietnamPro text-base font-normal text-white outline-none transition duration-[0.3] ease-in-out focus-visible:outline-none`}
