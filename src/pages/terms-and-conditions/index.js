...
const TermAndConditions = () => {
  return (
    <>
      ...
      {/* @main */}
      <main className="relative pt-[129px] xl:pt-[139px] 2xl:pt-[209px]">
        <Container>
          <div className="ca2024ArtcleFrmattd text-black-900 font-bevietnamPro font-light leading-normal mb-24">
            <h1>TERMS & CONDITIONS</h1>
            <h2>General Regulations</h2>
            <p>
              Welcome to Coinfest Asia 2024! These terms and conditions outline
              the rules and regulations for the use of Coinfest Asia 2024's
              Website, located at{" "}
              <a href="https://coinfest.asia">https://coinfest.asia</a>. By
              accessing this website we assume you accept these terms and
              conditions. Do not continue to use Coinfest Asia 2024 if you do
            ...
            &nbsp;
            <p>
              By purchasing a ticket for COINFEST ASIA 2024, Event Attendee has
              agreed to all applicable Terms and Conditions. All forms of
              violation of the terms and conditions will be dealt with strictly.
            </p>
            <ul>
              <li>
              ...
              <li>
                ...
                (authorized ticket box). Otherwise Event’s attendees will not be
                able to verify if the e-ticket is an authorized or unauthorized
                copy.
              </li>
              <li>
                Each e-ticket has a unique QR code and is only valid for one
                person. E-ticket can only be used once. E-ticket duplication for
                multiple entries to the event are prohibited.
              </li>
              <li>
                Your ticket purchase constitutes a personal license to attend
                COINFEST ASIA 2024 conference and festival. By purchasing a
                ticket, you agree to your personal data collection and usage.
              </li>
              <li>
            ...
            <ul>
              <li>
                Organizer reserves the right to take action to prohibit entry to
                the venue or exchange the E-ticket for actual ticket/pass on the
                e-ticket with QR code that has been used previously by others.
              </li>
              <li>
                Organizer reserves the right to process and litigate in
                accordance with Indonesia regulations through civil criminal
                proceedings against people who make illegal ticket purchases,
                including but not limited to counterfeiting or copying a valid
                ticket or get a ticket in a way that do not match those
                specified by the organizer as in item (a) of this provision.
              </li>
              <li>
                Organizer is not responsible for any negligence that resulted in
                E-ticket / pass being misplaced or lost (or in the mastery of
                others’ hands) and is used to enter the venue by others.
              </li>
              <li>
                Organizer has the right to prohibit visitors from entering the
                event location if visitors do not have a valid ticket.
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                Each ticket purchased must be registered by including legal and
                valid name
              </li>
              <li>
              ...
              <li>
                The ticket uses a unique QR code, is used for one time use and
                is only valid for one person.
              </li>
              <li>
                Organizer reserves the right to take any reasonable and
                necessary measures to prohibit/decline/prevent visitors/ticket
                users from entering the event venue if the e-ticket with the QR
                Code has been previously used by someone else.
              </li>
              <li>Ticket prices are subject to change without prior notice.</li>
              <li>
                The number of tickets and capacity available for each category
                is LIMITED.
              </li>
              <li>Ticket sales are made on a "first buy first serve" basis.</li>
              <li>Ticket prices include taxes and services.</li>
              <li>
                Tickets that has been purchased cannot be exchanged nor refunded
                for any reason.
              </li>
              <li>
                Organizer reserves the right to process and litigate in
                accordance with Indonesian regulations either in civil or
                criminal proceedings against people who got tickets in ways that
                are not valid, including but not limited to counterfeiting or
                copying a valid ticket or buying a ticket in a way that do not
                match those specified by the Organizer.
              </li>
              <li>
                Organizer is not responsible for negligence of the ticket
                purchaser / owner that resulted in the purchaser’s ticket
                falling into the hands of others (in the mastery of others) to
                be used as an admission that eliminates the ticket purchaser
                from entering the venue.
              </li>
              <li>
                Ticket purchasers and ticket users hereby declares to waive all
                legal rights to file a counterclaim through the court or any
                other legally permitted means to sue the Organizer in the event
                of an event cancellation which is unilaterally carried out by
                the artist or the government or for other reasons beyond the
                control and the will of the Organizer.
              </li>
              <li>
                All ticket buyers and visitors are deemed to have read,
                understood and agreed to the Terms and Conditions for the Event.
              </li>
            </ul>
            <h2>Cookies</h2>
            <p>
              We employ the use of cookies. By accessing Coinfest Asia 2024, you
              agreed to use cookies in agreement with the Coinfest Asia 2024's
              Privacy Policy.
            </p>
            <p>
            ...
            <h2>License</h2>
            <p>
              Unless otherwise stated, Coinfest Asia 2024 and/or its licensors
              own the intellectual property rights for all material on Coinfest
              Asia 2024. All intellectual property rights are reserved. You may
              access this from Coinfest Asia 2024 for your own personal use
            ...
            <ul>
              ...
              <li>
                Reproduce, duplicate or copy material from Coinfest Asia 2024
              </li>
            ...
            <p>
              ...
              opinions and information in certain areas of the website. Coinfest
              Asia 2024 does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of Coinfest Asia 2024,its agents and/or
              ...
              applicable laws, Coinfest Asia 2024 shall not be liable for the
              ...
              appearance of the Comments on this website. Coinfest Asia 2024
            ...
            <p>
              ...
              Coinfest Asia 2024; and (d) the link is in the context of general
              ...
              the context of the linking party’s site. If you are one of the
              ...
              Coinfest Asia 2024. Please include your name, your organization
              name, contact information as well as the URL of your site, a list
              of any URLs from which you intend to link to our Website, and a
              list of the URLs on our site to which you would like to link. Wait
              2-3 weeks for a response. Approved organizations may hyperlink to
