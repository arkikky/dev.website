...
const CustomerSuccessfullyActivation = ({ mode }) => {
  return (
    <>
      {/* @head */}
      <HeadGraphSeo
        title={`Customer Successfully Activation`}
        otherPage={true}
      />
...
CustomerSuccessfullyActivation.getLayout = (page, { pageProps }) => {
...
export default CustomerSuccessfullyActivation;
