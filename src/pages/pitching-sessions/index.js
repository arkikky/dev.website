          ...
          <header className="ca2024BgLineMint relative mx-2 mb-10 mt-2 flex h-[796px] flex-col items-center justify-center overflow-hidden rounded-[20px] bg-[#0095A0] sm:mx-2.5 sm:mb-15 sm:mt-3.5 sm:rounded-[26px] lg:mx-5 lg:mb-[88px] lg:mt-5 lg:h-[750px]">
            ...
            <div className="relative z-[5] -mt-[105px] flex w-full max-w-full flex-col text-center sm:max-w-[551px] lg:max-w-[711px]">
              ...
              <div className="mt-14 flex flex-col items-center justify-center text-white">
                <span className="font-light">Invited government agencies</span>
                <div class="mx-auto inline-flex w-max flex-row items-center justify-center space-x-2 mt-4">
                  <div>
                    <Image
                      className="mx-auto h-full w-auto overflow-hidden rounded-[14px] object-cover object-center"
                      src="/assets/images/pitching-sessions/ca2024_OJK.png"
                      alt={`Coinfest Asia 2024 (Pitching Sessions Partners)`}
                      height={168}
                      width={240}
                      quality="87"
                    />
                  ...
                  <div>
                    <Image
                      className="mx-auto h-full w-auto overflow-hidden rounded-[14px] object-cover object-center"
                      src="/assets/images/pitching-sessions/ca2024_Bappenas.png"
                      alt={`Coinfest Asia 2024 (Pitching Sessions Partners)`}
                      height={168}
                      width={240}
                      quality="87"
