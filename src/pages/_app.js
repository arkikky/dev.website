  ...
  if (Component.getLayout) {
    ...
    return Component.getLayout(
      <>
        ...
        <button
          id="mdlBtnSuccessNewsletter"
          className="mdlBtnSuccessNewsletter toolsApp bg-transparent hidden flex-col items-center justify-center cursor-pointer rounded-[10px] outline-none absolute top-full bottom-0 left-auto right-0 h-8 w-8 opacity-0 invisible z-10"
          ...
          aria-labelledby="Modal Success Newsletter"
          data-hs-overlay="#mdlSuccessNewsletter"
        ></button>

        {/* @modal (Subscribe) */}
        <div
          id="mdlSuccessNewsletter"
          ...
          <div className="flex items-center justify-center absolute top-0 bottom-0 sm:inset-y-0 inset-x-0 mt-8 hs-overlay-open:mt-0 mx-auto px-4 sm:px-0 w-full sm:max-w-[547px] opacity-0 hs-overlay-open:opacity-100 transition-all duration-300 ease-out">
            <div className="bg-white flex flex-col rounded-xl sm:rounded-[18px] text-center relative py-8 sm:py-14 px-7 sm:px-12">
              <button
                ...
                aria-labelledby="mdlSuccessNewsletter"
                data-hs-overlay="#mdlSuccessNewsletter"
              >
                <svg
                  className="h-4 w-4"
              ...
              <div className="flex flex-col text-center">
                ...
                <p className="text-black-900 font-figtree text-base sm:text-lg font-medium mt-4 px-0 sm:px-7">
                  Thank you for your interest for Coinfest Asia 2024. You will
                  be the first to receive news and updates—including for the
                  upcoming Coinfest Asia 2024.
                </p>
              </div>
            </div>
          </div>
