...
const SideEvents = ({ ipAddrs, formSideEvents, countryRegion }) => {
  ...
  const onSubmit = async (data) => {
    ...
    const isConfig = {
      ...
      context: {
        pageUri: "https://coinfest.asia/get-involved/side-events",
        pageName: "Side Events | Coinfest Asia 2024",
  ...
  return (
    <>
      ...
      {/* @main */}
      <PartnershipLayouts
        title="Coinfest asia 2024 Side Event inquiry"
        btnBack={true}
...
SideEvents.getLayout = function PageLayout(page) {
  return <>{page}</>;
};
