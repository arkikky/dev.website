...
const PartnerMediaSuccessfullySubmitted = ({ mode }) => {
  return (
    <>
      {/* @head */}
      <HeadGraphSeo
        title={`Partner Media Successfully Submitted`}
        otherPage={true}
      />
...
PartnerMediaSuccessfullySubmitted.getLayout = (page, { pageProps }) => {
...
export default PartnerMediaSuccessfullySubmitted;
