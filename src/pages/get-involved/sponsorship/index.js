...
const SponsorshipGetInvolved = ({
  ...
  return (
    <>
      ...
      {/* @main */}
      <PartnershipLayouts
        title="Coinfest asia 2024 sponsorship inquiry"
        btnBack={true}
        ...
        >
          <div className="flex flex-col">
            ...
            <div className="mb-4 grid-cols-1 gap-x-4 gap-y-4 last:mb-0 supports-grid:grid sm:grid-cols-2">
              ...
              <div className="flex flex-col">
                <label
                  htmlFor="mobilephoneSponsorship"
                  className="mb-2 text-start font-bevietnamPro text-base font-normal text-black-900"
                >
            ...
            <div className="mb-4 grid-cols-1 gap-x-4 gap-y-4 last:mb-0 supports-grid:grid sm:grid-cols-2">
              ...
              <div className="flex flex-col">
                ...
                <Select
                  ...
                  options={frmSponsorship.formFieldGroups[5].fields[0].options}
                />
              </div>
            </div>
          </div>
              ...
              {frmSponsorship && (
                <div className="flex flex-col">
                  ...
                  <Select
                    ...
                    options={
                      frmSponsorship.formFieldGroups[8].fields[0].options
                    }
                  />
                </div>
              )}
          ...
          <div className="flex flex-col">
            ...
            <div className="mb-6 flex flex-col last:mb-0">
              ...
              <div className="grid space-y-4">
                {frmSponsorship.formFieldGroups[11].fields[0].options?.map(
                  (gRslt, i) => (
                    <label
            ...
            <div className="mb-6 flex flex-col last:mb-0">
              ...
              <div className="grid space-y-3">
                {frmSponsorship.formFieldGroups[13].fields[0].options?.map(
                  (gRslt, i) => (
                    <div className="space-y-2" key={i}>
                      <label
