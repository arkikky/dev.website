...
const PartnerCommunitySuccessfullySubmitted = ({ mode }) => {
  return (
    <>
      {/* @head */}
      <HeadGraphSeo
        title={`Partner Community Successfully Submitted`}
        otherPage={true}
      />
...
PartnerCommunitySuccessfullySubmitted.getLayout = (page, { pageProps }) => {
...
export default PartnerCommunitySuccessfullySubmitted;
