...
const FAQ = () => {
  ...
  return (
    <>
      <section className="ca2024MainPoints ca2024FaqPoints flex flex-col items-center justify-center overflow-hidden relative pt-[144px] lg:pt-[163px] pb-32 lg:pb-24">
