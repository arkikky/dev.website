...
const GetInvolved = () => {
  return (
    <>
      <section className="ca2024MainPoints ca2024GetInvolved ca2024MainScreenAuto relative flex snap-start snap-always flex-col items-start justify-start bg-transparent">
        {/* @point-items (backdrop) */}
        <div className="ca2024GetInvolvedPointsItems opacity-1 pointer-events-none absolute -bottom-17 -left-[227px] right-auto z-[18] select-none bg-transparent transition duration-[0.8s] ease-out sm:-bottom-[133px] sm:-left-[479px] sm:top-auto lg:-bottom-[179px] lg:-left-[637px] xl:-bottom-[185px] xl:-left-[493px]">
          <Image
        ...
        <Container className="relative z-20">
          <div className="relative flex flex-col overflow-hidden pb-[165px] pt-[144px] sm:pb-[299px]">
            ...
            <div className="relative mt-8 grid-cols-4 gap-x-2 gap-y-2 supports-grid:grid sm:grid-cols-12 lg:grid-cols-12">
              <div className="col-span-full col-start-1 grid-cols-4 gap-x-2 gap-y-2 supports-grid:grid sm:grid-cols-12 sm:gap-x-6 sm:gap-y-6 lg:col-span-10 lg:col-start-2 lg:grid-cols-12 xl:col-span-10 xl:col-start-2">
                ...
                <div className="col-span-2 sm:col-span-4">
                  <GetInvolvedCard
                    ...
                    label="Co-Host Side Event"
                  >
                    <GetInvolvedImages
                      style="mx-auto h-full w-full scale-[1.4] transform object-cover object-center"
                      src={"/assets/images/get-involved/ca2024CoHost.jpeg"}
                      alt={`Coinfest Asia 2024 (Co-Host A Side Event - Get Involved)`}
                      height={563}
                      width={1000}
                      quality="87"
                    />
                ...
                <div className="col-span-2 sm:col-span-4">
                  <GetInvolvedCard
                    ...
                    label="Submit Side Event"
                  >
                    <GetInvolvedImages
                      style="mx-auto h-full w-full scale-[1.5] transform object-cover object-center"
                      src={"/assets/images/get-involved/ca2024Submit.jpeg"}
                      alt={`Coinfest Asia 2024 (Submit Side Event - Get Involved)`}
                      height={563}
                      width={1000}
                      quality="87"
                    />
