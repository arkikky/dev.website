...
const DefaultTicket = () => {
  ...
  return (
    <>
      <section className="ca2024SldeTicket bg-secondary2024 snap-always snap-start flex flex-col items-center justify-center overflow-hidden relative h-auto sm:h-svh xl:h-screen min-h-[auto] sm:min-h-svh xl:min-h-screen">
        ...
        <Container className="overflow-hidden relative z-[5]">
          <div className="flex flex-col overflow-hidden relative pt-[144px] xl:pt-[84px] pb-[292px] sm:pb-[172px]">
