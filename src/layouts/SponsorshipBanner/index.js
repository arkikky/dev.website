  ...
  return (
    <>
      ...
      >
        <div
          ref={bgBannerImgs}
          className="caBnnerSponsor bg-[url('/assets/images/banner/caBanner-2025Sponsorship.jpg')] bg-[length:295%] sm:bg-[length:147%] lg:bg-[length:125%] bg-cover bg-no-repeat object-cover xl:object-center object-center absolute inset-y-0 inset-x-0 h-full w-full -z-px transition-all ease-linear"
        ></div>
