...
const Navbar = ({
  ...
  return (
    <>
      <nav
        className={`caNavbar bg-transparent fixed top-0 bottom-auto inset-x-0 h-[61px] sm:h-[84px] px-2 sm:px-6 lg:pl-11 lg:pr-[64px] xl:h-24 w-full ${
          intMenu
            ? "z-base active"
            : intScroll
          ...
          <div className="flex flex-row items-center justify-end">
            {/* <Links
              className={`py-2 sm:py-4 px-3 sm:px-4 flex flex-row items-center text-sm sm:text-base justify-center ${
                modeDifferent === true ? "bg-white" : "bg-black-900 text-white"
