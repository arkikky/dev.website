            ...
            <div className="flex w-max flex-row">
              ...
              {nonStore === false && (
                <div className="col relative mr-2.5 hidden items-center justify-center lg:flex">
                  <button
                    className="relative flex h-[80%] flex-col items-center justify-center rounded-lg bg-secondary px-3 py-3 text-sm leading-initial text-white sm:h-auto sm:rounded-[10px] sm:text-base"
                    type="button"
                    tabIndex={-1}
                    role="button"
