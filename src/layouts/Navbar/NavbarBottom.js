    ...
    <>
      ...
      >
        <Container className="relative h-full">
          ...
          {/* @navbar-main */}
          <div
            className={`ca2024NavbarMain relative mx-auto flex h-full w-full flex-row items-center justify-between rounded-[20px] border border-solid border-white/[0.16] bg-black-900/25 px-2 py-2 lg:w-[857px] xl:w-[877px] ${
              isMenu ? "!w-full" : null
            } z-100 max-w-full`}
          >
            {/* @menu */}
