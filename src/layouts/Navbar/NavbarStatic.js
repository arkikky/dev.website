...
import MenuNavbar from "@components/UI/Menu/MenuNavbar";
import MobileMenuNavbar from "@components/UI/Menu/MobileMenuNavbar";
...
const NavbarBottom = () => {
  ...
  useEffect(() => {
    ...
    const nvMnu = document.querySelector(".ca2024NavMenuMobile");
        ...
        <Container className="h-full">
          ...
          >
            ...
            <div className="flex flex-row ml-0 sm:ml-4">
              ...
              {router.pathname !== "/get-involved" ? (
                <button
                  id="mdlBtnNavbarNewsletter"
