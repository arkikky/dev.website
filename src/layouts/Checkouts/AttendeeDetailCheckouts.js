      ...
      <div className="space-y-4">
        ...
        <div className="grid-cols-1 gap-x-4 gap-y-4 supports-grid:grid sm:grid-cols-2">
          ...
          >
            ...
            <Select
              ...
              withSearch={true}
              config={{
                ...register(`companyFocus${arrIndex}`, {
        ...
        >
          ...
          <Select
            ...
            config={{
              ...register(`whatTypeConnectionNetworking${arrIndex}`, {
        ...
        >
          ...
          <Select
            ...
            config={{
              ...register(`didYouHearAbout${arrIndex}`, {
