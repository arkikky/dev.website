...
const SocialMentions = ({ data }) => {
  ...
  return (
    <>
      <section className="ca2024MainPoints ca2024SocialMentionsPoints relative z-10 flex h-auto snap-start snap-always flex-col items-center justify-center overflow-hidden bg-white">
        ...
        <Container className="relative z-[5] overflow-hidden">
          <div className="relative flex flex-col overflow-hidden pb-[254px] pt-[154px] sm:pt-[194px] xl:pb-[202px]">
            ...
            <div
              ...
              className="ca2024SocialMentions bckdrpCvrShdow pointer-events-none relative mb-28 mt-20 flex flex-col transition duration-[2.2s] ease-out sm:mt-28 lg:pointer-events-auto"
            >
              <Marquee
                autoFill={false}
                pauseOnHover={false}
                direction="down"
                speed={30}
                className="flex h-[600px] w-full flex-col"
              >
