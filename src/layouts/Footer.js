...
const Footer = ({ nonStore = false }) => {
  return (
    <>
      <footer
        className={`ca2024Footer ca2024SectionEnd relative justify-end overflow-x-hidden ${nonStore === true ? 'pb-8' : 'pb-[92px] sm:pb-28 lg:pb-8'} pt-10`}
      >
        <Container>
          <div className="relative flex flex-col items-start justify-start">
            <div className="block w-full">
              <div className="block w-full pr-0 text-sm font-medium sm:pr-4 lg:pr-0 xl:text-wrap xl:pr-[98px]">
            ...
            <div className="mt-8 flex w-full flex-col items-start justify-start sm:mt-10 lg:flex-row lg:items-center lg:justify-between">
              <div className="w-full max-w-[567px] font-bevietnamPro text-sm font-light prose-a:text-primary prose-a:underline prose-strong:font-medium prose-strong:text-primary xl:max-w-max">
