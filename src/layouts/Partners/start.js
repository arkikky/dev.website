...
const StartPartners = () => {
  return (
    <>
      <section className="ca2024StartPartners snap-always snap-start flex flex-col items-center justify-center overflow-hidden relative h-svh xl:h-screen min-h-svh xl:min-h-screen transition duration-[1s] ease-in-out">
