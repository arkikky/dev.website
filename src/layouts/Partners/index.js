...
const Sponsor = ({ data }) => {
  ...
  return (
    <>
      <section id="caPartners" className="mt-12 sm:mt-24">
        ...
        <div className="supports-grid:grid grid-cols-4 sm:grid-cols-12 xl:grid-cols-10 gap-y-2 sm:gap-y-4 gap-x-2 sm:gap-x-4 relative mt-6 sm:mt-10">
          ...
          <div className="col-span-2 sm:col-span-4 lg:col-span-3 xl:col-span-2">
            <div className="flex flex-col items-center justify-center border border-solid border-primary rounded-[5px] sm:rounded-[10px] grayscale-0 transition duration-300 ease-in-out px-0 min-h-[118px] sm:min-h-[155px] xl:min-h-[176px]">
