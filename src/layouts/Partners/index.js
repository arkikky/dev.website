...
const Partners = ({ mode, result = [] }) => {
  return (
    <>
      <section className="ca25Partners relative bg-[linear-gradient(-2deg,#1F1F1F_28%,#005AFF_63%,#7AB1F9_81%,#A0CCF7_100%)] pb-8 pt-[64px] sm:pb-6 lg:pt-20 xl:pb-20 xl:pt-[122px]">
