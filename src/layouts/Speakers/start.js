...
const StartSpeakers = () => {
  return (
    <>
      <section className="ca2024StartSpeaker bg-secondary2024 snap-center snap-always flex flex-col items-center justify-center overflow-hidden relative h-svh min-h-svh">
        {/* @background (backdrop) */}
        ...
        <div className="ca2024SldeSpeakersStartPointsItems bg-transparent absolute top-auto -bottom-[229px] sm:-bottom-[405px] 2xl:-bottom-[527px] left-auto -right-[203px] sm:-right-[325px] lg:-right-[415px] select-none pointer-events-none z-px opacity-1 transition duration-[0.8s] ease-out">
          <Image
            ...
            alt={`Coinfest Asia 2024 (Start Speakers Points Items - Right)`}
            height={1635}
            width={958}
            quality="87"
          />
        ...
        <Container className="relative z-[5]">
          <div className="ca2024StartSpeakerContent flex flex-col text-start opacity-1 transition duration-[1.2s] ease-out">
            <h2 className="text-white font-staraBold text-[32px] xs:text-[42px] sm:text-[58px] lg:text-[80px] leading-[40px] xs:leading-[50px] sm:leading-[74px] lg:leading-[90px] uppercase">
