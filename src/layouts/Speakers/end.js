...
const EndSpeakers = () => {
  return (
    <>
      <section className="ca2024EndSpeakers snap-start snap-always flex flex-col items-center justify-center overflow-hidden relative h-svh xl:h-screen min-h-svh xl:min-h-screen">
