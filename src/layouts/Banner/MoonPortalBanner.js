    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-x-auto inset-y-auto z-[12] mx-auto mt-[7px] w-full max-w-[265px] text-center sm:mt-0 sm:max-w-[415px] lg:-mt-[21px] lg:max-w-[655px] xl:mt-[5]">
          ...
          <Link
            className={`ca25MoonBtn-Embossed relative mx-auto inline-flex w-[138px] items-center justify-center rounded-full bg-[#ED4F35] px-3 py-2.5 text-sm  leading-initial font-semibold uppercase text-white disabled:pointer-events-none disabled:opacity-90 sm:w-[237px] sm:px-6 sm:py-5 xl:w-[237px]`}
            prefetch={true}
            href="/tickets"
