...
const PortalBanner = ({ id = 'ca25PortalBanner0', mode }) => {
  return (
    <>
      <div
        className={`${id} ca25BgDiamondPortal 3xl:!w-[1583px] 3xl:h-[617px] relative mx-auto flex h-[231px] w-full max-w-full flex-col items-center justify-center sm:h-[343px] lg:h-[457px] xl:h-[516px]`}
      >
