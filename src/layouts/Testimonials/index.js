  ...
  return (
    <>
      <div className="ca2024Testimonials bg-white snap-always snap-start flex flex-col items-center justify-center overflow-hidden relative h-svh xl:h-screen min-h-svh xl:min-h-screen">
        ...
        <div className="ca2024TestimonialsBackdrop absolute inset-y-0 inset-x-0 opacity-1 z-px transition duration-[1s] ease-out">
          <Image
        ...
        <div className="flex flex-col relative -mt-5 w-full z-[22]">
          <Container>
            <Splide
              ...
              label="Coinfest Asia 2024 (Testimonials)"
              aria-label="Coinfest Asia 2024 (Testimonials)"
              options={{
                updateOnMove: true,
                type: "loop",
                perPage: 1,
