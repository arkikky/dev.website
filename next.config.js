      ...
      },
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: `default-src 'self';script-src 'self' 'unsafe-eval';style-src 'self' 'unsafe-inline' https://fonts.googleapis.com;font-src 'self' https://fonts.gstatic.com;connect-src 'self' https://api.coinfest.asia http://coinfest-2025.vercel.app https://api.hsforms.com https://hub.coinvestasi.com https://checkout-staging.xendit.co/;img-src 'self' https://upload.wikimedia.org https://hub.coinvestasi.com http://coinfest-2025.vercel.app https://flagcdn.com https://checkout-staging.xendit.co/ data:;frame-src 'none';frame-ancestors 'self';form-action 'self';worker-src 'self';base-uri 'self';`,
          },
          {
